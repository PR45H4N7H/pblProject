...
class ApprovedProjects extends Component {
    ...
    componentDidMount() {
        projectService.getApprovedProjects().then((res) => {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <h2 className="text-center" style={{ paddingBottom: "10px" }}>APPROVED PROJECTS</h2>

                <div className="container">
                    <div className="row">
                        {projects.map((project) => (
                            <div key={project.projName} className="col-md-4 mb-3">
                                <div className="card" style={{ color: "#006A4E", height: "250px" }}>
